local _ = loadstring(game:HttpGet("https://raw.githubusercontent.com/JustANGITHUBA5/limitedhubv2real/main/source.lua"))()
local b = _:New({Name = "                                      LimitedHub", FolderToSave = "SolarisLibStuff"})
local _ = b:Tab("Info")
...
a:Button(
    ...
    function()
        ...
        _:SetCore("SendNotification", {Title = "Credits", Text = "KeksCraft#7802 and Lvcky#6779", Duration = 15})
    end
)
a:Button(
    "Discord Server",
    function()
        ...
        wait(0.5)
        setclipboard("https://discord.gg/DaswmnkfBJ")
    end
)
h:Button(
    "Blackvalk",
